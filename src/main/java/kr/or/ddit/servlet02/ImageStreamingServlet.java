...
//		String contentsPath = config.getInitParameter("contentsPath");
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String alreadyImages = utils.getCookieValue(Constants.IMAGESTREAMINGCOOKIENAME); 
		...
		Cookie imageCookie = CookieUtils.createCookie("imageCookie", json, TextType.PATH, req.getContextPath(), 60*60*24*2);
